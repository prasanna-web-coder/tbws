...
if (typeof Object.create !== "function") {
    ...
    var i = {
        ...
        buildNavigation: function() {
            ...
            if (t) {
                var n = '<ul class="pagination" style="margin: 0px;">' + '<li><a href="#" class="prev"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li>' + '<li><a href="#" class="next"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>' + '</ul><div class="clearfix"></div>';
